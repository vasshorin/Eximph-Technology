export const Features = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Service we provide</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at Eximph we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Delivery</h3>
              <p class="text-gray-500 dark:text-gray-400">Our team will help you with the delivery of your equipment to the destination of your choice.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Factory acceptance tests</h3>
              <p class="text-gray-500 dark:text-gray-400">When the equipment is ready, we will perform the factory acceptance tests to ensure that everything is working properly, and up to your standards.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Commissioning</h3>
              <p class="text-gray-500 dark:text-gray-400">Once the equipment is delivered, our personel will help you with the commissioning of the equipment at your factory.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Personal training</h3>
              <p class="text-gray-500 dark:text-gray-400">To ensure that your team is ready to operate the equipment, we will provide training for your personel.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">We will take care of the logistics of the equipment from the manufacturers to your factory.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">We will provide all of the designing and technical documentation for the equipment to help you choose the right products that fit your needs.</p>
          </div>
      </div>
  </div>
</section></>
