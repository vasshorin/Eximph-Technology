            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">Service we provide</h2>
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Here at Eximph we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                <svg className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM8 9a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1zm0 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1zm1-7a1 1 0 100 2h2a1 1 0 100-2H9z" clipRule="evenodd"></path></svg>
                            </div>
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Delivery</h3>
                            <p className="text-gray-500 dark:text-gray-400">Our team will help you with the delivery of your equipment to the destination of your choice.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Factory acceptance tests</h3>
                            <p className="text-gray-500 dark:text-gray-400">When the equipment is ready, we will perform the factory acceptance tests to ensure that everything is working properly, and up to your standards.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Commissioning</h3>
                            <p className="text-gray-500 dark:text-gray-400">Once the equipment is delivered, our personel will help you with the commissioning of the equipment at your factory.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Personal training</h3>
                            <p className="text-gray-500 dark:text-gray-400">To ensure that your team is ready to operate the equipment, we will provide training for your personel.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Logistics</h3>
                            <p className="text-gray-500 dark:text-gray-400">We will take care of the logistics of the equipment from the manufacturers to your factory.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Documentation</h3>
                            <p className="text-gray-500 dark:text-gray-400">We will provide all of the designing and technical documentation for the equipment to help you with the installation and maintenance.</p>
                        </div>
                    </div>
                </div>
            </section>
