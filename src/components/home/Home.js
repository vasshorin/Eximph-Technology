            ...
            <div className="relative px-4 py-32 mx-auto max-w-screen-xl">
              <h1 className="text-4xl font-extrabold tracking-tight text-center text-white sm:text-5xl md:text-6xl">
                ...
                <span className="block text-blue-200">
                  Your trusted partner for top-of-the-line pharmaceutical
                  equipment
                </span>
              </h1>
            </div>
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              ...
              <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
                We are a leading provider of pharmaceutical equipment and
                installation services, with a strong track record of delivering
